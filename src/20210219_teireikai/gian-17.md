...
# ⛏️議案第17号　小平市立障害者福祉施設条例の一部を改正する条例
...
<fieldset class="point">
  ...
  <p class="point">✔ 初の「児童発達支援センター」を小平市障害者福祉センター内に新設するための条例改正</p>
  <p class="point">✔ 機能が追加されるため、小平市障害者福祉センターを「たいよう福祉センター」に改名</p>
  <p class="point">✔ 発達支援相談、保護者への支援、障害児にかかる研修、啓発に関することを新たに規定</p>
  <p class="point">✔ 既存施設内に設置している音楽室、録音室を廃止するため、当該の規定を削除</p>
</fieldset>
...
<fieldset class="sanpi">
  ...
  <p class="sanpi">以下の問題はあるものの、まずは児童発達支援センターの導入が必要であるため賛成</p>
  <p class="sanpi">⚠️ 言語訓練のリソース不足に対する対策が取られていない</p>
  <p class="sanpi">⚠️ 教育委員会との連携がうまくとれていない状態が続いたまま</p>
  <p class="sanpi">⚠️ 18歳未満の発達障害児潜在数2,000人に対し、規模が小さすぎるのではないか</p>
</fieldset>
