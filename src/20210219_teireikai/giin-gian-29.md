...
昔と違い、焼却炉の性能が向上している現代では、「燃やせるものは燃やした方が環境にもよく、社会全体の総コストが下がる」とも言われています。古い知識に基づいて、独断と偏見に基づいて決まった可能性の高い「ごみを細かく分別する必要性」についても再点検する必要があります。新設備も、そういった観点に一部対応できるような、高い焼却能力があるようです。焼却しても問題のないものは焼却するようにすれば、小平市で処理できるごみの総量も増えるはずです。環境のためにも、市民の負担を減らすという意味でも、ごみ処理施設については、既存の設備計画の範疇でよいので、すべてを洗い直した方がよいと考えています。

なお、これまで調べてきたことから判断すると、ごみ焼却施設には「過大」な投資が行われ、市民の福祉を悪化させていると考えています。これも機会をみてまとめたいと思います。
...
2点目は、制度移行や条例等の改正には、多くの時間が必要という問題。
...
指定収集袋の販売利益が主な収入源となっている事業者に対しては、多大な影響を及ぼす。これらのことから、制度移行には相当な時間が必要であると考えます。
...
ここは闇が深そうに思いますので、機会をみつけて追及します。

</div>

<div class="balloon bl-right">環境部長（田中）<br><div>

3点目は、小村大和衛生組合における新焼却施設の更新に影響を与える問題。
...
これも分別方法、焼却するもの等の見直しで解決する可能性があります。

</div></div>

　４点目としまして、市民意見聴取や現状分析といったプロセスを経ていない点でございます。
　令和５年度を始まりとします次期一般廃棄物処理基本計画の策定に向けて、小平市廃棄物減量等推進審議会にて協議してまいりますが、その中でごみ処理手数料につきましては、ごみ組成分析による分別状況の検討や減量持続効果等を分析した上で検討することになると考えております。
　当審議会につきましては、日頃からごみの減量に対して意識の高い市民公募委員が審議会委員の半数以上おりまして、このほか学識経験者や市内事業者で構成され、そこでの審議を踏まえた上で検討していく必要があると考えております。
　５点目としまして、分別の徹底がまだ十分ではないという点でございます。
　現時点において、プラスチック製容器包装の分別不適正の割合は、最新の組成分析では２０％以上ございました。この数値からも分別が大幅に改善したとは言い難く、無料とすることで、さらに分別の徹底が難しくなると考えております。また、不適物が増加した場合は、搬入先のスリーハーモニーにおいて、手作業による分別作業を増加させ、コスト増にもつながってまいります。このため、小平市だけでなく、東大和市、武蔵村山市にも影響を与えることに留意する必要がございます。
　６点目としまして、歳入の減少でございます。
　燃やすごみ、燃やせないごみを半額、プラスチック製容器包装を無償とした場合、市に与える影響額は、令和元年度決算からの推計ではおおよそ３億円程度の減となり、そのほかごみ量が増加した場合には、翌々年度以降の小平・村山・大和衛生組合及び他の広域資源循環組合の分担金の増加が見込まれます。このため、今後の市全体の政策にも大きな影響を及ぼすおそれがございます。
　なお、他の広域資源循環組合の分担金につきましては、令和元年度の家庭ごみ有料化に伴うごみ減量などの理由により、令和３年度は前年度に比べおおよそ８,９００万円ほどの減額となったところで、これが再び増額となる可能性もございます。
　以上のことなどから、今回提出された条例案を実施する場合には、小平市のみならず、広域支援をお願いする各市、小平・村山・大和衛生組合を構成する東大和市及び武蔵村山市にも大きな影響と混乱を与えることになると考えます。さらには、市民や関連事業者などにも大きな影響と混乱を及ぼすことが考えられております。
